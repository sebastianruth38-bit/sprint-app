# Two stages. First find the bright-kit athlete in the pack, then crop tightly
# to him and run pose again on that crop alone -- neighbours are excluded
# spatially rather than hoped away, which is the only thing that works when
# bodies overlap.
